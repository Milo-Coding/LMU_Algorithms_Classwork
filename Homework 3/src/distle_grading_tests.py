...
class DistleGradingTests(unittest.TestCase):
    """
    ...
    def tearDownClass(cls: Any) -> None:
        print("===============================================")
        print("[*] TOTAL WINS: ##" + str(DistleGradingTests.TOTAL_WINS) + "##")
    ...
    def report_results(self, win_list: list[bool]) -> float:
        ...
        DistleGradingTests.TOTAL_WINS += wins
