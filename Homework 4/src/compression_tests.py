...
class CompressionTests(unittest.TestCase):
    ...
    def test_constructor_t3(self) -> None:
        huff_coder = ReusableHuffman("ACCBBB")
        solution = {ETB_CHAR: '100', "A": '101', 'B': '0', 'C': '11'}
        self.assertEqual(solution, huff_coder.get_encoding_map())
    ...
    def test_constructor_t5(self) -> None:
        huff_coder = ReusableHuffman("AGREEABLE")
        solution = {ETB_CHAR: '1010', "A": '00', 'G': '010', "R": '100', 'E': '11', "B": '1011', 'L': '011'}
        self.assertEqual(solution, huff_coder.get_encoding_map())

    def test_constructor_t6(self) -> None:
        huff_coder = ReusableHuffman("HELLO WORLD")
        solution = {ETB_CHAR: '0110', "H": '1110', 'E': '1101', "L": '10', 'O': '00', "W": '010', 'R': '1111' , 'D': '1100', " ": '0111'}
        self.assertEqual(solution, huff_coder.get_encoding_map())
    ...
    def test_compression_t5(self) -> None:
        huff_coder = ReusableHuffman("HELLO WORLD")
        compressed_message = huff_coder.compress_message("WELL HOORLD")
        solution = bitstrings_to_bytes(['01011011', '01001111', '11000001', '11110110', '00110000'])
        self.assertEqual(solution, compressed_message)
    ...
    def test_decompression_t5(self) -> None:
        # byte 0: 0101 0110 (100 = ETB, 101 = 'A', 0 = 'B', 11 = 'C')
        # byte 1: 1110 0000
        # [!] Only first 5 bits of byte 1 are meaningful (rest are padding)
        huff_coder = ReusableHuffman("HELLO WORLD")
        compressed_msg: bytes = bitstrings_to_bytes(['01011011', '01001111', '11000001', '11110110', '00110000'])
        self.assertEqual("WELL HOORLD", huff_coder.decompress(compressed_msg))
